...
class Route {
    ...
    {
        $config = $config ?: require \Core\Framework::$config_path.'route.php';
        ...
        //载入配置
        $config = require \Core\Framework::$config_path.'route.php';
        //缓存类
        $cache = Base\Cache\Cache::getInstance()->getDriver($config['cache_handler']);
        //缓存存在直接返回
