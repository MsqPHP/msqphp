...
class CaptchaTool {
    ...
    public static function createCaptcha(int $type = 3, int $length = 4, int $pixel = 0, int $line = 0) {
        static $_width = 80;
        static $_height = 28;
        //1.创建画布
        ...
        //4.得到字符
        $_chars = static::buildRandomString($type, $length);
        //5.存入本对象中
        static::$_captcha_chars = $_chars;
        //6.字体
