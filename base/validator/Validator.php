...
final class Validator
{
    ...
    public static function color(string $color) : bool
    {
        static $patterns = array(
            ...
            '/^[rR][gG][bB][aA]\\(((100%|[0-9][0-9]?%|0),){3}([01]\\.?[0-9]?[0-9]?)\\)$/',//rgba(0%,0%,0%,0.00)->RGBA(100%,100%,100%,1)
            '/^[rR][gG][bB][aA]\\(((2[0-4][0-9]|25[0-5]|[01]?[0-9][0-9]?),){3}(100%|[0-9][0-9]?%|0)\\)$/',//rgb(0,0,0,0)->RGB(255,255,255,100%)
            '/^[rR][gG][bB][aA]\\(((2[0-4][0-9]|25[0-5]|[01]?[0-9][0-9]?),){3}([01]\\.?[0-9]?[0-9]?)\\)$/',//rgb(0%,0%,0%,0.00)->RGB(100%,100%,100%,1)
        );
