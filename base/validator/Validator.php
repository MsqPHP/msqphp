...
final class Validator
{
    ...
    {
        $pattern = array(
            '/^\#([0-9a-fA-F]{6})$/',//#000000->#FFFFFF
            '/^\#([0-9a-fA-F]{3})$/',//#000->#FFF
            '/^[rR][gG][bB]\(((2[0-4][0-9]|25[0-5]|[01]?[0-9][0-9]?),){2}(2[0-4][0-9]|25[0-5]|[01]?[0-9][0-9]?)\)$/',//rgb(0,0,0)->RGB(255,255,255)
            '/^[rR][gG][bB]\(((100%|[0-9][0-9]?%|0),){2}(100%|[0-9][0-9]?%|0)\)$/',//rgb(0%,0%,0%)->RGB(100%,100%,100%)
            '/^[rR][gG][bB][aA]\(((100%|[0-9][0-9]?%|0),){3}(100%|[0-9][0-9]?%|0)\)$/',//rgba(0%,0%,0%,0%)->RGBA(100%,100%,100%,100%)
            '/^[rR][gG][bB][aA]\(((100%|[0-9][0-9]?%|0),){3}(0\.[0-9][0-9]?|1)\)$/',//rgba(0%,0%,0%,0.00)->RGBA(100%,100%,1)
            '/^[rR][gG][bB][aA]\(((2[0-4][0-9]|25[0-5]|[01]?[0-9][0-9]?),){3}(100%|[0-9][0-9]?%|0)\)$/',//rgb(0,0,0,0)->RGB(255,255,255,100%)
            '/^[rR][gG][bB][aA]\(((2[0-4][0-9]|25[0-5]|[01]?[0-9][0-9]?),){3}(0\.[0-9][0-9]?|1)\)$/',//rgb(0%,0%,0%,0.00)->RGB(100%,100%,100%,1)
        );
        for ($i = 0, $l = count($pattern); $i < $l; ++$i) {
            if (preg_match($pattern[$i], $color)) {
                unset($pattern);
                return true;
            }
        }
